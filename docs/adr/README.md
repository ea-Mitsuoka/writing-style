...
| [0002](0002-extract-correction-candidates-from-claude-code-transcripts.md) | 指摘候補の抽出を、記録を読むだけの独立モジュールと人の仕分けで行う | extraction モジュール、セッション記録との境界、機密の扱い | accepted | 2026-09-18 |
